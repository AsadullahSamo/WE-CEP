...
const FilterBar = ({ onFilterChange, onRefresh, isRefreshing, data }) => {    const [filters, setFilters] = useState({
        search: '',
        year: '',
        crop: '',
        region: ''
    ...
    useEffect(() => {
        if (data && data.length > 0) {
            ...
            // Ensure we get ALL crops regardless of other active filters
