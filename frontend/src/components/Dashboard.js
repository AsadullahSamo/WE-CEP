...
const Dashboard = () => {
    ...
    const applyFilters = () => {
        ...
        // Apply year filter - ensure both are strings and handle 'all' case
        if (filters.year !== 'all') {
        ...
        result.sort((a, b) => String(a.year).localeCompare(String(b.year)));
    ...
    return (
        <div className={`dashboard ${isRefreshing ? 'refreshing' : ''}`}>
            ...
            <FiltersPanel filters={filters} setFilters={setFilters} data={agriculturalData} />
            ...
            <div className="dashboard-table" style={{marginTop: '100px'}}>
